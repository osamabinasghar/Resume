						...
						<div className="row">
							<div className="col-lg-4 offset-lg-1">
								...
								<div className="d-flex flex-column gap-2 mt-9 position-relative z-1">
									<Link href="tel:+923463556423">
										<i className="ri-phone-fill text-primary-3 fs-7" />
										<span className="text-300 fs-6 ms-2">+92 346 355 6423</span>
									</Link>
									...
									<Link href="https://www.linkedin.com/in/hira-j-042764150/">
										<i className="ri-linkedin-fill text-primary-3 fs-7" />
										<span className="text-300 fs-6 ms-2">Hira Javed</span>
									</Link>
									<Link href="https://www.google.com/maps/place/1st+Ave.,+New+York,+NY,+Hoa+K%E1%BB%B3/@40.7630169,-73.9594939,17z/data=!4m6!3m5!1s0x89c258c29e084453:0x2bf768350d30b89e!8m2!3d40.7630169!4d-73.9594939!16zL20vMDV3Z2tm?entry=ttu&g_ep=EgoyMDI0MDkxNi4wIKXMDSoASAFQAw%3D%3D">
										...
										<span className="text-300 fs-6 ms-2">Karachi, Pakistan</span>
									</Link>
								</div>
							</div>
							<div className="col-lg-7 pt-lg-0 pt-8">
								<div id="about" className="hero-3 pe-lg-5 border-bottom pb-7">
									...
									<h2 className="text-300 my-3">Crafting Stories <span className="text-dark">with Passion: Discover the Work</span> of Hira</h2>
									<p className="mb-8">As an accomplished HR professional holding a Master's in Business Administration, I bring robust expertise across a spectrum of critical disciplines within human resources management. With a proven track record spanning Recruitment and Selection, Training and Development, Strategic Performance Management, and Organizational Development, I am adept at navigating the complexities of talent management and organizational enhancement.</p>
												...
												<div className="cards">
														...
														<div className="card__inner rounded-4 border border-secondary-3 bg-white p-lg-5 p-md-4 p-3">
															...
															<div className="card__content px-md-4 px-3 pt-lg-0 pb-lg-8 pb-5">
																<div className="card__title mb-0 mb-lg-2">
																	...
																	<Link href="#">
																		<p className="fs-3 text-dark">Job Knock</p>
																	</Link>
																</div>
													...
													<div className="card-custom pt-0" data-index={1}>
														<div className="card__inner rounded-4 border border-secondary-3 bg-white p-lg-5 p-md-4 p-3">
															...
															<div className="card__content px-md-4 px-3 pt-lg-0 pb-lg-8 pb-5">
																<div className="card__title mb-0 mb-lg-2">
																	<p className="text-300 fs-5 mb-0">2024</p>
																	<Link href="#">
																		<p className="fs-3 text-dark">Influence 360</p>
																	</Link>
																</div>
																<p className="text-300 mb-lg-auto mb-md-4 mb-3">Set in a dystopian future, "Reflections of Tomorrow" is a thought-provoking novel that explores themes of identity, freedom, and resilience. Through its compelling storyline and well-drawn characters, the book invites readers to ponder the ethical dilemmas of technological advancement and societal change.</p>
															</div>
								...
								<div id="contact" className="contact pt-70">
									...
									<div className="d-flex align-items-center gap-5 mt-4">
										...
										<div className="d-flex flex-column gap-2 position-relative z-1">
											<Link href="https://www.linkedin.com/in/hira-j-042764150/">
												<i className="ri-linkedin-fill text-primary-3 h6 fw-medium" />
												<span className="text-300 fs-6 ms-https://www.google.com/maps/place/1st+Ave.,+New+York,+NY,+Hoa+K%E1%BB%B3/@40.7630169,-73.9594939,17z/data=!4m6!3m5!1s0x89c258c29e084453:0x2bf768350d30b89e!8m2!3d40.7630169!4d-73.9594939!16zL20vMDV3Z2tm?entry=ttu&g_ep=EgoyMDI0MDkxNi4wIKXMDSoASAFQAw%3D%3D"> Hira Javed</span>
											</Link>
											<Link href="#">
